...
CGFloat const kTWMessageViewIconSize = 46.0f;
...
NSString * const kTWMessageBarStyleSheetImageIconError = @"icon-avatar";
NSString * const kTWMessageBarStyleSheetImageIconSuccess = @"icon-avatar";
NSString * const kTWMessageBarStyleSheetImageIconInfo = @"icon-avatar";
    ...
    if ([self.delegate respondsToSelector:@selector(styleSheetForMessageView:)])
    {
        ...
        CGContextSaveGState(context);
        {
            if ([styleSheet respondsToSelector:@selector(iconImageForMessageType:)])
            {
                ...
                CGRect frame = CGRectMake(xOffset, yOffset, kTWMessageViewIconSize, kTWMessageViewIconSize);
//                [image drawInRect:frame];
                
                UIBezierPath *circularPath = [UIBezierPath bezierPathWithRoundedRect:frame cornerRadius:frame.size.height/2.0];
