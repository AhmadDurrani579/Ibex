...
{
    UIAlertController *alert = [UIAlertController alertControllerWithTitle:@"STREET PIN" message:@"Please enter your App PIN" preferredStyle:UIAlertControllerStyleAlert];
...
- (void)showImagePickerWithType:(UIImagePickerControllerSourceType)type sender:(UIView *)sender withCompletionBlock:(MediaSelectionHandler)block{
    ...
    self.imagePickerVC.popoverPresentationController.sourceView = sender;
    self.imagePickerVC.popoverPresentationController.sourceRect = sender.bounds;
    self.imagePickerVC.popoverPresentationController.permittedArrowDirections = UIPopoverArrowDirectionAny;
...
- (void)showVideoPickerWithType:(UIImagePickerControllerSourceType)type sender:(UIView *)sender withCompletionBlock:(MediaSelectionHandler)block{
    ...
    self.imagePickerVC.mediaTypes = @[(NSString *)kUTTypeMovie,(NSString *)kUTTypeVideo,(NSString *) kUTTypeMPEG2Video, (NSString *) kUTTypeQuickTimeMovie, (NSString *) kUTTypeMPEG, (NSString *) kUTTypeMPEG4];
    
    self.imagePickerVC.videoQuality = UIImagePickerControllerQualityTypeMedium;
    
    self.imagePickerVC.allowsEditing = YES;
    
    self.imagePickerVC.videoMaximumDuration = 600.0f;
