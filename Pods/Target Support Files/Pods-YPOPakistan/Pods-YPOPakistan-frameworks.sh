...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/FinalStarRatingBar/FinalStarRatingBar.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/SRMonthPicker/SRMonthPicker.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SVHTTPRequest/SVHTTPRequest.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/TTCustomCallout/TTCustomCallout.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/US2FormValidator/US2FormValidator.framework"
