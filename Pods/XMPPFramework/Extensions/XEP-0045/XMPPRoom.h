...
@interface XMPPRoom : XMPPModule
{
    ...
    __strong NSString *roomDescription;
...
- (id)initWithRoomStorage:(id <XMPPRoomStorage>)storage jid:(XMPPJID *)aRoomJID dispatchQueue:(dispatch_queue_t)queue withDescription:(NSString*)Description ;
